...
namespace RTS_Cam
{
    ...
    public class RTS_Camera : MonoBehaviour
    {
	    ...
	    public float leftLimitX = 0f; //x limit of map
	    public float limitX = 50f; //x limit of map
	    public float leftLimitY = 0f; //x limit of map
        ...
        private void LimitPosition()
        {
	        ...
	        m_Transform.position = new Vector3(Mathf.Clamp(m_Transform.position.x, leftLimitX, limitX),
                m_Transform.position.y,
		        Mathf.Clamp(m_Transform.position.z, leftLimitY, limitY));
        }
